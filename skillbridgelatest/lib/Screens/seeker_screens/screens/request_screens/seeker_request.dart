...
import '../../../provider_screens/screens/profile_view_screens/dummy.dart';
import 'recieve_seeker_request.dart';
import 'send_seeker_request.dart';

class RequestsSeeker extends StatelessWidget {
  const RequestsSeeker({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        body: TabBarView(
          children: [RecieveSeekerRequestScreen(), const SendSeekerRequests()],
        ),
      ),
    );
  }
