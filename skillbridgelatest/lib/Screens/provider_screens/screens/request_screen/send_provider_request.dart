  ...
  Widget build(BuildContext context) {
    ...
    docRef.get().then((DocumentSnapshot documentSnapshot) {
      if (documentSnapshot.exists) {
        myList = documentSnapshot.get('hiringApplicantList');
        print(myList);
      } else {}
    });
  ...
  Widget build(BuildContext context) {
    ...
    docRef.get().then((DocumentSnapshot documentSnapshot) {
      if (documentSnapshot.exists) {
        ...
        gender = documentSnapshot.get('seekerGender');
        name = documentSnapshot.get('seekerName');
        seekerImage = documentSnapshot.get('seekerImage');
      } else {}
    });
    return DefaultTextStyle(
      style: Theme.of(context).textTheme.displayMedium!,
                      ...
                      children: [
                        Container(
                          ...
                          child: ClipRRect(
                            ...
                            child: Image.network(seekerImage),
                          ),
                        ),
                        Column(
